    ...
    <>
      ...
      <V.FunctionWrapper isMyArticle={isMyArticle}>
        ...
        <V.BtnWrap>
          ...
          <V.SaveBtn
            src={
              articleInfo.isArticleSaved
                ? "/src/assets/saveimage.png"
                : "/src/assets/unsaveimage.png"
            }
            onClick={handleSave}
          />
          <V.LikeBtn
            src={
              articleInfo.isArticleLiked
          ...
          />
          <V.LikeRate>
            <V.DropdownToggle onClick={handleLikeUser}>
              {" "}
          ...
          <V.VideoContentArea>
            ...
            <V.VideoAccuracyArea>
              <V.VideoUpperContainer>
                <div>
                  {`${createdDate[0]}. ${createdDate[1]}. ${createdDate[2]}.`} &nbsp; |&nbsp; 조회
                  수 {articleInfo.view}
                </div>
              </V.VideoUpperContainer>
